...
def parse_args() -> argparse.Namespace:
    ...
    cmd_compile.add_argument("-o", "--output", default="tabular_classification_pipeline_spec.json",
    ...
    cmd_run_job.add_argument("--gcs_input_file_uri", required=True, help="Training dataset path.")
